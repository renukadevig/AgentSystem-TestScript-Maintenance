...
export function cfgForName(channelName) {
    ...
    return {
        ...
        // Reference/production URL: lets the heal distinguish "broken in this
        // build" from "feature intentionally removed" (obsolete test).
        prodUrl: c.prodUrl || process.env.AUTOFIX_PROD_URL || '',
    };
}
